...
/* const SecondForm = () => {
    ...
    const[modal, setModal] = useState(false);
    const[platform, setPlatform] = useState(initialValuesInfo.platformsSecondForm);

    const onSubmit = (values) =>{
      const{genreSecondForm, deviceSecondForm, streamingSecondForm } = values;

      const changeInitialValuesInfo = {genreSecondForm , deviceSecondForm, streamingSecondForm, platformsSecondForm: platform }
